...
\functionality{$\beta$-Reduktionen angezeigen}{fbc:show-beta-reduction}
...
\functionality{Schrittweise Auswertung}{fnc:stepbystep}
Nach der Eingabe kann sich der Benutzer durch drücken des \enquote{Step-Buttons} nur den jeweils nächsten Schritt anzeigen lassen.
...
\tests{fnc:chrome-design}\tests{fnc:input}\tests{fnc:ln}\tests{fnc:mobile}\tests{fnc:night-mode}
...
\tests{fnc:eval-order-normal}\tests{fnc:eval-order-options}
