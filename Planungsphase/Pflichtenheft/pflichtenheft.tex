...
\criterium{Input editieren}{crt:output-readonly}
...
Der Benutzer kann Tastatur-Shortcuts benutzen um schnelleren Zugriff auf bestimmte Programmfunktionen zu haben.
...
\functionality{$\beta$-Reduktionen anzeigen}{fnc:stepbystep}
...
\nonFunctionality{Begrenzter LaTeX export}{nfc:limited-export-latex}
