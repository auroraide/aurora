...
\fulfills{crt:intermediate-step-output}
In der GUI wird dem Benutzer nach einer erfolgreichen Berechnung ein \enquote {3-Punkte}-Butto angezeigt. Wenn er auf diesen klickt, werden ihm alle $\beta$-Reduktion-Schritte angezeigt, die durchgeführt wurden, um auf das Ergebnis zu kommen.
...
\fulfills{crt:shortcuts}
Drücken von Shift \enquote {+} p ist äquivalent zum Drücken des \enquote {Pause}-Buttons.
...
{ Der Benutzer drückt auf den \enquote {3-Punkte}-Button um alle Schritte zu sehen die bei der $\beta$-Reduktion durchgeführt wurden. }
...
{Im Schrittfeld werden die ersten 15 Zwischenschritte angezeigt. Der \enquote {3-Punkte}-Button ist unter den Zwischenergebnissen sichtbar.}
...
{Der Benutzer drückt gleichzeitig Shift \enquote {+} t }
{Die Berechnung terminiert wie sie es getan hätte, hätte der Benutzer den \enquote{Terminate}-Button gedrückt}
