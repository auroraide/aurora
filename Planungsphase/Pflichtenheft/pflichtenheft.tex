...
\newline Dieses Popup erscheint, sollte sich in der Eingabe ein Syntax Fehler.

\textbf{(2) Schleifenerkennung}
\newline Dieses Popup erscheint, sollte das Programm eine Endlosschleife erkennen.
