...
\functionality{Normalform erkennen}{fnc:output}
Das Programm erkennt, falls ein $\lambda$-Ausdruck in Normalform vorliegt, bzw. keine weiteren $\beta$-Reduktion durchgeführt werden können.
