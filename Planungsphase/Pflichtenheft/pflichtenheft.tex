...
Bibliothek, in der vordefinierte Funktionen und Church-Zahlen verfügbar sind.

\criteriumOptional{Benutzerbibliothek}{crt:user-library}
Bibliothek, in der der Benutzer eigene Funktionen definieren und speichern kann.
