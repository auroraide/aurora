...
\test{Einstellungsmenue}{tst:settings}
\tests{F27}
\teststep{Das Programm befindet sich im Default-Zustand.}
{Der Benutzer drueckt auf den Einstellungen Knopf.}
{Die Sidebar wird mit der Einstellungen-Sidebar ersetzt.}

\teststep{...}
{Der Benutzer drueckt auf \enquote{Lanauge}.}
{Die Einstellungen-Sidebar wird mit einer Liste von menschlichen Sprachen ersetzt.}

\teststep{...}
{Der Benutzer drueckt auf \enquote{Russian}.}
{Die Sprache vom Programm aendert sich auf Russisch und die Sprach-Listen-Sidebar und
