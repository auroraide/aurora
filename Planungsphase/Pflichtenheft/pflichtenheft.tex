...
\functionality{Der Benutzer kann eine laufende Berechnung über einen Stop-Button vorzeitig beenden.}{fnc:stop-exec}
...
\functionality{Das äußere Erscheinungsbild der Applikation kann über die "Night mode"-Funktion zu einem dunklen Farbschema geändert werden.}{fnc:night-mode}
...
\functionality{Der Benutzer kann die Berechnung des $\lambda$-Terms über den Run-Button starten.}{fnc:run}
\functionality{Die "Run"-Funktion liest $\lambda$-Terme über das Eingabefeld ein.}{fnc:run-input}
