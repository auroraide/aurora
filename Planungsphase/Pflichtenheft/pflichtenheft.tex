...
\functionality{Funktionen der Standardbibliothek}{fnc:func-name-def}
\fulfills{crt:std-library}
...
\functionality{Erweitern der Benutzerbibliothek}{fnc:userlib}
\fulfills{crt:user-library}
Der Benutzer kann Funktionen zur Benutzerbibliothek hinzufügen.

\functionality{Entfernen aus der Benutzerbibliothek}
