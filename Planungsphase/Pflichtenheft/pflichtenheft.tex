...
%\criteriumOptional{Zusätliche Auswertungsstrategien sind Call by Name und Call by Value}{crt:opt-eval-strategy}

%\criteriumOptional{Auswertungsstrategie  }

\criteriumOptional{Share-Funktion}{crt:share-feature}

Generiere eine Kurz-URL mit \enquote{Copy to clipboard} Funktion, die $\lambda$urora, mit vorgefertigten Input im Text Editor, im Webbrowser öffnet.
...
\criteriumOptional{Lambda-Term vom Text-Editor oder von der Schrittliste in Latex-Syntax übersetzen}{crt:latex-export}
Hat \enquote{Copy to Clipboard} Funktion.
...
\item Lambda-Zeichen, Punkte, Church Zahlen, Namen aus der Standard oder Benutzerbibliothek, gebundene und freie Variablen, werden farblich, differenziert im Text-Editor und Schrittfeld dargestellt.

\item Ein Redex, der als nächstes reduziert werden soll, erhält einen farbigen Hintergrund.

\item Beim \enquote{darüber hovern} des Lambda-Zeichens oder der Klammer, wird der zum Lambda-Zeichen gehörende Redex bzw. das was von der Klammer umschlossen wird , farblich hervorgehoben.
\end{itemize}
...
\criteriumOptional{Syntax Highlighting Permium}{crt:syntax-highlighting-premium}
