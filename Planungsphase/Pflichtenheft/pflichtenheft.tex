...
\functionality{Offensichtliche Schleifen erkennung}{fnc:loop-test}
Eine laufende Berechnung wird automatisch auf Schleifen überprüft. Wenn eine offensichtliche Schleife gefunden wurde warnt das Programm davor.
...
\nonFunctionality{Begrenzter port}{nfc:limited-latex-export}
