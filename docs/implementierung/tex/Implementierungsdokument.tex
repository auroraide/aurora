...
%=====================STATISTIKEN=====================
\section{Statistik}
\textbf{Machen wir das rein?}
\subsection{Lines of Code}
Statistik SLOC? 07.02: src ~Java 3205 ~XML 282 ~CSS 64
test ~Java 920
Zeilen Javadoc: kein Plan
...
Alle im Pflichtenheft definierten Pflichtkriterien sind in der aktuellen Version von Aurora umgesetzt worden.

\subsection{Wunschkriterien}
Neben den Pflichtkriterien wurden in der ersten Phase auch Wunschkriterien definiert.
Im folgenden ist eine Auflistung aller implementierten Wunschkriterien.
\newline
\newline
...
\newline
\textbf{K7} STANDARDBIBLIOTHEK \textbf{Nikolai, wie siehts aus?}
\newline
\textbf{K8} BENUTZERBIBLIOTHEK \textbf{Nikolai, wie siehts aus?}
\bigbreak
\textbf{K9} Weitere Auswertungsstrategien
\smallbreak
\textbf{K11} Mehrere Schritte auswerten \textbf{Nikolai}
\newline
...
\begin{itemize}
	...
	dieser Package von Term erben, aber bei dieser Klasse dies extra dazustand. Auch ist für den abstrakten Syntaxbaum
	...
	Diese werden in Function.term gespeichert. Dannach kann nur ein neues parsen, welches einen neuen abstrakten
...
Während der Implementierung sind wir nur auf wenige wirklich unerwartete Probleme gestoßen,
die uns dafür aber um so mehr Zeit gekostet haben, um wirklich vollends behoben werden zu können:
\begin{itemize}
    ...
    \item BetaReducer
    \newline
    Wir hatten im Entwurf bereits ein Prototyp eines Betareduzieres geschrieben und er hatte ein richtiges Ergebnis
	für eine Beispielrechnung geliefert. Dass dieses richtige Ergebnis purer Zufall war und dass der Betareduzierer
	falsch gerechnet hatte musste ich recht lange debuggen. Als das Problem stellte sich am Ende ein falscher Shift der
	Debruijn-Indizes heraus, die nur bei manchen Reduktionen relevant sind.
