...
\texdocconstructor{public}{HighlightedLambdaExpression}{()}{Standard constructor, that initializes an empty HighlightedLambdaExpression.}{}
\texdocconstructor{public}{HighlightedLambdaExpression}{(Term t)}{Constructor that analyzes a Term and creates the HighligtedLambdaExpression}{\begin{texdocparameters}
\texdocparameter{t}{the Term that gets analyzed.}
...
\label{texdoclet:aurora.backend.HighlightedLambdaExpression.Token}
\begin{texdocclassintro}
A single token.\end{texdocclassintro}
\begin{texdocclassconstructors}
\texdocconstructor{public}{Token}{(HighlightedLambdaExpression.TokenType type, String name)}{Constructor, that creates a new Token.}{\begin{texdocparameters}
...
\begin{texdocclassconstructors}
\texdocconstructor{public}{TreePath}{()}{This constructor initializes an empty TreePath.}{}
\end{texdocclassconstructors}
\begin{texdocclassmethods}
...
\texdocmethod{public}{void}{push}{(TreePath.Direction d)}{Add a new enum to the List.}{\begin{texdocparameters}
...
\texdocmethod{public}{boolean}{hasTerm}{(String name)}{Checks if the function is already in the Library.}{\begin{texdocparameters}
\texdocparameter{name}{The name of the function.}
\end{texdocparameters}
\texdocreturn{The boolean if the name is already in the Library.}
}
...
\begin{texdocclassconstructors}
\texdocconstructor{public}{FreeVariable}{(String name)}{Get the name of the free variable as a string.}{\begin{texdocparameters}
\texdocparameter{name}{}
\end{texdocparameters}
}
\end{texdocclassconstructors}
...
\begin{texdocclassmethods}
\texdocmethod{public}{T}{accept}{(TermVisitor\textless{}T\textgreater{} visitor)}{}{}
\texdocmethod{public}{Term}{getInner}{()}{Return the Term inside the parentheses.}{\texdocreturn{The Term inside the parentheses.}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\texdocmethod{public}{CodeMirrorPanel}{getInputCodeMirror}{()}{}{}
\texdocmethod{public}{CodeMirrorPanel}{getOutputCodeMirror}{()}{}{}
\texdocmethod{public}{FlexTable}{getOutputFieldTable}{()}{}{}
\end{texdocclassmethods}
\end{texdocclass}
...
\end{texdocclassfields}
\begin{texdocclassconstructors}
\texdocconstructor{public}{RedexClickedEvent}{(TreePath redex)}{Constructor.}{\begin{texdocparameters}
...
\texdocmethod{public}{}{getAssociatedType}{()}{}{}
\texdocmethod{public}{TreePath}{getRedex}{()}{Gets the path pointing to an Application, which is the selected redex.}{\texdocreturn{The Redex selected by the user.}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\end{texdocclassfields}
\begin{texdocclassconstructors}
\texdocconstructor{public}{ShareEmailEvent}{(HighlightedLambdaExpression highlightedLambdaExpression, Library userLibrary)}{Simple constructor.}{\begin{texdocparameters}
...
\texdocparameter{userLibrary}{User's current library.}
\end{texdocparameters}
}
\end{texdocclassconstructors}
\begin{texdocclassmethods}
...
\texdocmethod{public}{}{getAssociatedType}{()}{}{}
\texdocmethod{public}{HighlightedLambdaExpression}{getHighlightedLambdaExpression}{()}{Gets the user's selected term to be shared.}{\texdocreturn{Selected term.}
}
\texdocmethod{public}{Library}{getUserLibrary}{()}{Gets the user's current user library.}{\texdocreturn{User's library.}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\end{texdocclassfields}
\begin{texdocclassconstructors}
\texdocconstructor{public}{ShortLinkEvent}{(HighlightedLambdaExpression highlightedLambdaExpression, Library userLibrary)}{Simple constructor.}{\begin{texdocparameters}
\texdocparameter{highlightedLambdaExpression}{The term (input, step, or output) the user has selected to be shared.}
\texdocparameter{userLibrary}{Reference to user's current user library.}
\end{texdocparameters}
}
\end{texdocclassconstructors}
\begin{texdocclassmethods}
...
\texdocmethod{public}{Library}{getUserLibrary}{()}{Gets the user's user library.}{\texdocreturn{User library.}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\end{texdocclassintro}
\begin{texdocclassmethods}
\texdocmethod{public}{void}{onShortLink}{(ShortLinkEvent event)}{Called when user wants to generate and share a short link to their input.}{\begin{texdocparameters}
\texdocparameter{event}{Event.}
\end{texdocparameters}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\texdocparameter{stepCount}{Amount of steps to perform, \textgreater{}= 1.}
\end{texdocparameters}
}
\end{texdocclassconstructors}
\begin{texdocclassmethods}
...
\texdocmethod{public}{}{getAssociatedType}{()}{}{}
\texdocmethod{public}{int}{getStepCount}{()}{Gets the amount of steps the user has selected to be evaluated.}{\texdocreturn{Amount of steps \textgreater{}= 1.}
}
\end{texdocclassmethods}
\end{texdocclass}
